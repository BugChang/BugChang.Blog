    ...
    <v-dialog v-model="dialogAgreement" max-width="800">
      <v-card tile>
        ...
        <v-card-text class="pt-2 text--primary">
          <p>
            尊敬的用户您好，欢迎您访问BugChang's
            Blog（以下简称：博客）。在您注册成为博客会员之前，请您务必认真阅读和理解《注册协议和隐私政策》（以下简称：协议）中所有的条款。您须完全同意协议中所有的条款，才可以注册成为本博客的会员，使用里面的服务。您在博客的注册和操作均将被视为是您对协议所有条款及内容的自愿接受。
          </p>
          <p>
            <b>第一条 声明</b>
          </p>
          <p>
            （一）博客内部分资源文章所有权归BugChang's Blog所有。
          </p>
          <p>
